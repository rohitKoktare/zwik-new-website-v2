      ...
      */}
      <div aria-hidden className="border-t border-[var(--gray-90)]">
        {/* <div className="overflow-hidden py-5">
          <div
            className="h-2 w-[calc(100%+144px)] animate-[zw-swatch-drift_3.2s_linear_infinite] will-change-transform"
            style={{
        ...
        */}
        <div className="overflow-hidden">
          ...
          <div className="flex w-max animate-[zw-marquee_150s_linear_infinite_reverse] will-change-transform">
            {[0, 1].map((half) => (
